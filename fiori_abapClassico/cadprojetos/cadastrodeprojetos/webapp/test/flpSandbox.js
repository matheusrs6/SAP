		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#portfoliocadastrodeprojetos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portfoliocadastrodeprojetos-display": {
								"semanticObject": "portfoliocadastrodeprojetos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portfolio.cadastrodeprojetos",
									"url": sap.ui.require.toUrl("portfolio/cadastrodeprojetos")
								}
							}
						}
					}
